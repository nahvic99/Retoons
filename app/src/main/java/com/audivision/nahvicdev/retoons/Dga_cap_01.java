...
public class Dga_cap_01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dga_cap_01);
    ...
    protected  void onStart() {
        ...
        ExtractorMediaSource mediaSource1 = new ExtractorMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse("http://toons.ddns.net/Toons/digimon_adventure/01.mp4"));
        ExtractorMediaSource mediaSource2 = new ExtractorMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse("http://toons.ddns.net/Toons/digimon_adventure/02.mp4"));

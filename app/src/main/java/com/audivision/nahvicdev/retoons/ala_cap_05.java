...
public class ala_cap_05 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ala_cap_05);
    ...
    protected  void onStart() {
        ...
        ExtractorMediaSource mediaSource5 = new ExtractorMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse("https://content-na.drive.amazonaws.com/cdproxy/share/rEzP1QWcyyxoYimwGidMXJmclO9RybjMKf7cdQ4MBQz/nodes/WzsxpbyQQ-qoA4V7yi_npA?nonce=W2h4AkqiOs9_CB0xnod67sepgiG_LP-3Mk-RSAzbu0tkLUDesAtet1TEDLXrxQBA"));

...
public class Dga_cap_04 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dga_cap_04);
    ...
    protected  void onStart() {
        ...
        ConcatenatingMediaSource concatenatedSource = new ConcatenatingMediaSource(mediaSource4, mediaSource5);
